    ...
    if (!isServiceItemCode && !isPureServiceCode) {
      ...
      for (const allocation of allocations) {
        ...
        $("#invoiceItemsBody tr").each(function () {
          ...
          if (existingCode === code && existingArn === allocation.arnId) {
            alreadyExists = true;
            return false;
          }
        });
        ...
        const row = `
          <tr>
            <td>${code}
              ...
              <input type="hidden" name="arn_ids[]" value="${allocation.arnId}">
              <input type="hidden" name="arn_costs[]" value="${arnCost}">
            ...
            <td>
              <button type="button" class="btn btn-sm btn-danger btn-remove-item" data-code="${code}" data-qty="${qtyFromArn}" data-arn-id="${allocation.arnId}">Remove</button>
            </td>
          </tr>
        `;
